...
<html>
	<head>
		...
		<!-- Tab Styling -->
		<title>Robotics IMS - Check Out</title>
    ...
    <body id="grad">
        ...
        <div class="welcome-container">
            <h3 class="welcome-text">Check In</h3>
        </div>
		<div class="account-info-container">
            <h3 class="account-info-text">Enter the item ID you want to check out:</h3>
        ...
        <script type="text/javascript">
            ...
            document.getElementById('matrix-scanner').addEventListener('click', () => {
                ...
                if (window_open) {
                    ...
                    if (result) {
                        ims_id = document.getElementById('ims-id')
                        ims_id.value = result
                        
                        document.getElementById('camera_button_icon').className = 'fas fa-camera'
                        source_id = document.getElementById('sourceSelectPanel').style = 'display:none'
                        var camera_id = document.getElementById('camera')
                        camera_id.remove() 
